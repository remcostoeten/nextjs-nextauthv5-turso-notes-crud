        ...
        >
            <CardContent className="p-6 relative z-10">
                <div className="flex justify-between items-center mb-2">
                    ...
                    <ChevronRight
                        className={`text-[#666] transition-transform duration-300 ${isHovered ? 'transform translate-x-1' : ''
                            }`}
                    />
                </div>
            ...
            <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-lg text-[#888] mb-12 max-w-2xl">
                        Explore the building blocks of our user interfaces. Consistent, flexible, and designed for scale.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <p className="text-[#888] mb-4">
                        To begin using our design system:
                    </p>
                    <ol className="list-decimal list-inside space-y-2 mb-6 text-[#888]">
                        <li>Explore each section to familiarize yourself with our design language.</li>
                        <li>Check the documentation for detailed usage guidelines and best practices.</li>
                        <li>Use the provided code snippets to implement components in your projects.</li>
                        <li>Reach out to the design team if you have any questions or need support.</li>
                    </ol>
                </motion.div>
            </div>
        </ScrollArea>
