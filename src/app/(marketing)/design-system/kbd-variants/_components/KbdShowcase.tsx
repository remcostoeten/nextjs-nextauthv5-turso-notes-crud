...
import { useKeyboard } from "@/core/hooks/useKbdKeyboard";
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {shortcuts.map((shortcut) => (
              <div
                key={shortcut.name}
                className="flex items-center justify-between bg-bg-section border-dark-section--lighter border shadow-sm hover:shadow-brand trans-all-500 p-3 rounded-lg border-outline"
              >
