...
const Emblor: React.FC<EmblorProps> = ({
    initialTags = [],
    variant = 'default',
    shape = 'default',
    ...
    const examples = [
        {
            title: 'Default Shape',
            description:
                'The standard tag input with slightly rounded corners.',
            component: (
                <Emblor
...
/>`,
        },
        {
            title: 'Square Shape',
            description:
                'A variant with sharp corners for a more structured look.',
            component: (
                <Emblor
