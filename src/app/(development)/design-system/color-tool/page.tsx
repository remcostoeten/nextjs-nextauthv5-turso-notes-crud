                ...
                <PopoverContent className="w-80">
                    <div className="grid gap-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                            You've picked your first color! Let's create a
                            folder to store it.
                        </p>
                        ...
                        <Button onClick={createNewFolderWithColor}>
                            Create Folder
                        </Button>
                    </div>
                </PopoverContent>
