...
export default function SearchModal() {
  ...
  return (
    <>
      ...
      {(isOpen || isClosing) && (
        <div
          className={`fixed inset-0 z-50 bg-background/80 backdrop-blur-sm flex items-center justify-center animate-in fade-in duration-300 ease-in-out origin-center ${isClosing ? "animate-out fade-out duration-300 ease-in-out" : ""
            }`}
        >
          <div
            className={`scale-in origin-center w-full max-w-xl h-[450px] grid place-items-center border-outline rounded-xl w-full bg-modal rounded-lg shadow-lg overflow-hidden animate-in zoom-in-95 duration-300 ease-out ${isClosing
