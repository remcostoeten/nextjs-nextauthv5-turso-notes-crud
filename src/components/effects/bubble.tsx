...
export default function Bubble({
    ...
    const bubbleStyle: React.CSSProperties = {
        ...
        boxShadow: 'inset 0 0.13vmin blue, inset 0 0.18vmin orange, inset 0.1vmin 0.1vmin orange',
    ...
    const beforeStyle: React.CSSProperties = {
        ...
        backgroundImage: 'conic-gradient(from -25deg at 80% 20%, transparent 85%, rgba(255,255,255,0.7) 94%, transparent 94%)',
        filter: 'blur(4px)',
    }
