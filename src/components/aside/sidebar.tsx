...
function SidebarIcon({ item, isActive }: SidebarIconProps) {
  ...
  return (
    <motion.div
      className={`relative z-50 flex items-center justify-center size-10 mb-2 rounded-md transition-colors duration-200 border ${isActive
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`h-full bg-body border-r border-outline flex flex-col items-center py-4 z-40 transition-all duration-300 ease-in-out ${isCollapsed ? "w-0" : "w-full"
          }`}
      >
        <motion.div
