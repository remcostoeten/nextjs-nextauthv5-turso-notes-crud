...
export function Triangle({ selected }: TriangleProps) {
  ...
  return (
    <motion.span
      ...
      className="absolute left-1/2 top-0 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rotate-45 rounded-tl border-outline bg-gradient-to-b from-section-lighter via-body to-card"
    />
  );
}
